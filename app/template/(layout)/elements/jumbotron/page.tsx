  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
        ...
        <PanelCodeHighlight
          title="Basic"
          codeHighlight={`<div className="prose bg-[#f1f2f3] px-4 py-9 sm:px-8 sm:py-16 rounded max-w-full dark:bg-black-7 dark:text-white-7 w-full mb-5">
    <h2 className="text-dark mb-5  mt-4 text-center text-5xl dark:text-white-7">Hello, world!</h2>
    <p className="lead mt-3 mb-4 dark:text-white-7">
    ...
    <p className="lead">
        ...
        >
          <div className="prose mb-5 w-full max-w-full rounded bg-[#f1f2f3] px-4 py-9 dark:bg-black-7 dark:text-white-7 sm:px-8 sm:py-16">
            <h2 className="mb-5 mt-4  text-center text-5xl text-dark dark:text-white-7">
              Hello, world!
            </h2>
            <p className="lead mb-4 mt-3 dark:text-white-7">
        ...
        <PanelCodeHighlight
          ...
          codeHighlight={`<div className="prose bg-[#f1f2f3] px-4 py-9 sm:px-8 sm:py-16 rounded max-w-full dark:bg-black-7 dark:text-white-7 w-full mb-5">
    <h2 className="text-dark mb-5  mt-4 text-center text-5xl dark:text-white-7">Fluid Jumbotron</h2>
    <p className="lead mt-3 mb-4 dark:text-white-7">This is a modified jumbotron that occupies the entire horizontal space of its parent.</p>
    <blockquote className="text-black p-5 ltr:pl-3.5 rtl:pr-3.5 bg-white shadow-md rounded-tr-md rounded-br-md border border-white-light border-l-2 !border-l-primary dark:bg-[#060818] dark:border-[#060818]">
        <div className="flex items-start">
            ...
            <p className="not-italic text-[#515365] text-sm dark:text-white-7 m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
        </div>
