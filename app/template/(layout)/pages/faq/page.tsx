...
import ComponentsPagesFaqWithTabs from "./ComponentsPagesFaqWithTabs";
...
const Faq = () => {
  return (
    <div className="text-black-7 dark:text-white-7">
      <div className="relative rounded-t-md bg-primary-7 bg-bg_knowledge_pattern bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
        <div className="absolute -bottom-1 -end-6 hidden text-[#DBE7FF] rtl:rotate-y-180 dark:text-[#1B2E4B] lg:block xl:end-0">
          <Image
            src="/assets/images/template/faq/faq-dark.svg"
            alt="faqs"
            className="dark-img w-56 object-cover xl:w-80"
          />
          <Image
            src="/assets/images/template/faq/faq-light.svg"
            alt="faqs"
            className="light-img w-56 object-cover xl:w-80"
          />
        </div>
