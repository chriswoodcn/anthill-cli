        ...
        <ul className="mb-5 grid grid-cols-3">
            <li className="mx-auto">
                <button type="button"
                    ...
                    bg-white dark:bg-[#253b5c] border-[3px] border-[#f3f2ee] dark:border-black-7 flex justify-center items-center w-16 h-16\`}
                  ...
                  className={`${
                    activeTab5 === 1
                      ...
                      : ""
                                                ...
                                                flex h-16 w-16 items-center justify-center border-[3px] border-[#f3f2ee] bg-white dark:border-black-7 dark:bg-[#253b5c]`}
                  onClick={() => setActiveTab5(1)}
                >
                  <IconHome />
                </button>
