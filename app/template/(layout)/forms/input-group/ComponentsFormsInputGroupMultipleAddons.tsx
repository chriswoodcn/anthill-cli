  ...
  return (
    ...
    <div className="mb-5">
        <div className="flex">
            ...
            <div className="bg-[#eee] flex justify-center items-center rounded-none px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-white-light dark:border-[#17263c] dark:bg-black-7">
                0.00
            </div>
    ...
    <div>
        <div className="flex">
            ...
            <div className="bg-[#eee] flex justify-center items-center rounded-none px-3 font-semibold border border-white-light dark:border-[#17263c] dark:bg-black-7">
                0.00
            </div>
        ...
        <form>
          <div className="mb-5">
            <div className="flex">
              ...
              <div className="flex items-center justify-center rounded-none border border-white-light bg-[#eee] px-3 font-semibold ltr:border-r-0 rtl:border-l-0 dark:border-[#17263c] dark:bg-black-7">
                0.00
              </div>
              <input
                type="text"
          ...
          <div>
            <div className="flex">
              ...
              />
              <div className="flex items-center justify-center rounded-none border border-white-light bg-[#eee] px-3 font-semibold dark:border-[#17263c] dark:bg-black-7">
                0.00
              </div>
