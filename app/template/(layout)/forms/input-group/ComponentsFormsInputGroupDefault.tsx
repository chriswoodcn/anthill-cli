...
const ComponentsFormsInputGroupDefault = () => {
    ...
    <div>
        <div className="flex">
            <div className="bg-[#eee] flex justify-center items-center ltr:rounded-l-md rtl:rounded-r-md px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-white-light dark:border-[#17263c] dark:bg-black-7 whitespace-nowrap">
                With textarea
            </div>
        ...
        >
            <div className="mb-5">
                <form>
                    ...
                    <div>
                        <div className="flex">
                            <div className="flex items-center justify-center whitespace-nowrap border border-white-light bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-black-7">
                                With textarea
                            </div>
                            <textarea rows={4} className="form-textarea ltr:rounded-l-none rtl:rounded-r-none"></textarea>
                        </div>
